...
class F29Handler(BaseHandler):
    ...
    commandMap = {
        ...
        "container_boot_image": commands.container_boot_image.F29_ContainerBootImage,
        "container_boot_options": commands.container_boot_options.F29_ContainerBootOptions,
        "container_registries": commands.container_registries.F29_ContainerRegistries,
        "container_storage": commands.container_storage.F29_ContainerStorage,
